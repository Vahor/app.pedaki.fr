...
export const RegionMap: { [provider in ServerProvider]: Record<string, string> } = {
  aws: {
...
export type ServerRegion<T> = T extends ServerProvider ? (typeof Region)[T][number] : never;
