...
export class Db extends pulumi.ComponentResource {
	...
	constructor(
		...
		const db = new rds.Instance(
			rdsName,
			{
				...
				allocatedStorage: 20, // TODO: make this configurable, min is 20
				maxAllocatedStorage: 50, // TODO: make this configurable
			...
			{ parent: this, dependsOn: [rdsSubnetGroup] },
		);
	...
	private instanceClass = (
		size: StackParameters<"aws">["database"]["size"],
	) => {
		switch (size) {
			case "small":
				return "db.t4g.micro";
